...
const API_BASE_URL = 'https://morning-gorge-31901.herokuapp.com'
...
export const putUser = (username,email, password) => axios.post(`${API_BASE_URL}/api/register`, {username,email,password },
  {
    headers: {
      Authorization: getToken()
    }
